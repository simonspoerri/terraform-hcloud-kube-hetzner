locals {
  ...
  hcloud_token = "7N6U4NCwDVZpwVkMDXtYiVX7ceIYpXMPHWRPpA7eVeVFHDcH58XhvP7aDPnpwK1i"
}
...
module "kube-hetzner" {
  ...
  # * Your ssh public key
  ssh_public_key = file("${path.module}/.ssh/id_ed25519.pub")
  ...
  ssh_private_key = file("${path.module}/.ssh/id_ed25519")
  ...
  traefik_acme_email = "simon.spoerri@minitools.ch"
